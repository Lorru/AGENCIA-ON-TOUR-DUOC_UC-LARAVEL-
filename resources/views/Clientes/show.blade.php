                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Titular del Viaje : </label>
                                        <p>{{ $contactoOferta->primer_nombre_datos_usuario . ' ' . $contactoOferta->segundo_nombre_datos_usuario . ' ' . $contactoOferta->primer_apellido_datos_usuario . ' ' . $contactoOferta->segundo_apellido_datos_usuario }}</p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Telefono Titular : </label>
                                        <p>{{ $contactoOferta->telefono_datos_usuario }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Correo Titular : </label>
                                        <p>{{ strtoupper($contactoOferta->email) }}</p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Direccion Institucion : </label>
                                        <p>{{ $contactoOferta->direccion_cliente }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
